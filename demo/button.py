...
normal_label = tgraphics.text.Label("normal button", '', False, False, 64, (0, 0, 0, 255))
...
toggle_label = tgraphics.text.Label("toggle button", '', False, False, 64, (0, 0, 0, 255))
...
disable_label = tgraphics.text.Label("disabled button", '', False, False, 64, (0, 0, 0, 255))

...
class DragableMixin(ElementABC):
    ...
    @event_handler
    def on_mouse_press(self, x, y, button, mods, first): 
        res = super().dispatch('on_mouse_press', x, y, button, mods, first=first)
    ...
    def on_mouse_drag(self, x, y, dx, dy, buttons): 
        res = super().dispatch('on_mouse_drag', x, y, dx, dy, buttons)
        if self._l_pos:
    ...
    @event_handler
    def on_mouse_release(self, x, y, button, mods, last): 
        res = super().dispatch('on_mouse_release', x, y, button, mods, last=last)
